...
from launch.cluster.legoset import (
    ClusterTemplate, add_pick, assemble, auto_roles, discover_templates,
    instantiate, load_legoset, prefill_picks, preview_ids, remove_last,
    validate,
)
from launch.cluster.member import ClusterError, Member, member_id
...
# The pick algebra the cluster FORM types into — moved here with the code
# it tests (2026-09-03): a form is where picks are entered, not where
# what-a-pick-means lives.
